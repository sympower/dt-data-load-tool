...
from data_load_tool.common.typing import TDataItem, TSortOrder
from data_load_tool.common.jsonpath import extract_simple_field_name

from data_load_tool.common.utils import is_typeerror_due_to_wrong_call
...
from data_load_tool.common.libs.sql_alchemy import (
    Engine,
    CompileError,
    create_engine,
    MetaData,
        ...
        with self.engine.connect() as conn:
            ...
            for partition in result.partitions(size=self.chunk_size):
                if self.backend == "sqlalchemy":
                    ...
                    from data_load_tool.common.libs.pandas_sql import _wrap_result
