...
from data_load_tool.common.incremental.typing import IncrementalArgs
from data_load_tool.extract.items import TTableHintTemplate
from data_load_tool.extract.hints import TResourceHintsBase
from data_load_tool.sources.helpers.rest_client.auth import AuthConfigBase, TApiKeyLocation

from dataclasses import dataclass, field

from data_load_tool.common import jsonpath
from data_load_tool.common.typing import TSortOrder, TColumnNames
from data_load_tool.common.schema.typing import (
    TTableFormat,
    TAnySchemaColumns,
...
from data_load_tool.extract.items import TTableHintTemplate
from data_load_tool.common.incremental.typing import LastValueFunc
...
class ResourceBase(TResourceHintsBase, total=False):
    """Defines hints that may be passed to `data_load_tool.resource` decorator"""
