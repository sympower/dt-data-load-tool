...
from data_load_tool.common.schema.utils import merge_columns
from data_load_tool.common.utils import update_dict_nested, exclude_keys
from data_load_tool.common.typing import add_value_to_literal
from data_load_tool.common import jsonpath

from data_load_tool.extract.incremental import Incremental
from data_load_tool.extract.utils import ensure_table_schema_columns
...
from data_load_tool.sources.helpers.rest_client.detector import single_entity_path
...
from data_load_tool.sources.helpers.rest_client.client import raise_for_status
...
def _merge_resource_endpoints(
    ...
    if (default_columns := default_config.get("columns")) and (columns := config.get("columns")):
        # merge only native data_load_tool formats, skip pydantic and others
