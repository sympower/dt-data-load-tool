...
def github_api_resource(api_secret_key: Optional[str] = data_load_tool.secrets.value):
...
def github_api_source(api_secret_key: Optional[str] = data_load_tool.secrets.value):
