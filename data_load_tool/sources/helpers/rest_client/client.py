...
from data_load_tool.common import jsonpath, logger
...
class RESTClient:
    ...
    def __init__(
        ...
        if session:
            ...
            # data_load_tool.sources.helpers.requests.session.Session), warn if
            ...
            from data_load_tool.sources.helpers.requests.retry import Client
