...
from data_load_tool.common.configuration.specs.base_configuration import configspec, NotResolved
...
class AuthConfigBase(AuthBase, CredentialsConfiguration):
    """Authenticator base which is both `requests` friendly AuthBase and data_load_tool SPEC
...
class OAuthJWTAuth(BearerTokenAuth):
    ...
    def obtain_token(self) -> None:
        try:
            ...
            raise MissingDependencyException("data_load_tool OAuth helpers", ["PyJWT"])
    ...
    def load_private_key(self) -> "PrivateKeyTypes":
        try:
            ...
            raise MissingDependencyException("data_load_tool OAuth helpers", ["cryptography"])
