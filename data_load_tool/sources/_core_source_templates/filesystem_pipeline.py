...
from data_load_tool.sources.filesystem import FileItemDict, filesystem, readers, read_csv
...
def stream_and_merge_csv() -> None:
    ...
    # you can also do data_load_tool pipeline standard_filesystem_csv show to confirm that all A801 were replaced with A803 records for overlapping day
    print(load_info)
    print(pipeline.last_trace.last_normalize_info)
