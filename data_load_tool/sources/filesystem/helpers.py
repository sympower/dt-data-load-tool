...
from data_load_tool.common.configuration import resolve_type
from data_load_tool.common.typing import TDataItem

from data_load_tool.sources import DltResource
from data_load_tool.sources.filesystem import fsspec_filesystem
from data_load_tool.sources.config import configspec, with_config
from data_load_tool.sources.credentials import (
...
def fsspec_from_resource(filesystem_instance: DltResource) -> AbstractFileSystem:
    ...
    return _get_fsspec(
        filesystem_instance.explicit_args.get("bucket_url", data_load_tool.config.value),
        filesystem_instance.explicit_args.get("credentials", data_load_tool.secrets.value),
    )
