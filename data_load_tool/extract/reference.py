...
from data_load_tool.common.typing import ParamSpec
from data_load_tool.common.exceptions import MissingDependencyException
from data_load_tool.common.warnings import Dlt04DeprecationWarning, deprecated

from data_load_tool.extract.source import DltSource
from data_load_tool.extract.exceptions import UnknownSourceReference
...
class SourceReference:
    ...
    def find(
        ...
        Expands shorthand notation into section.name eg. "sql_database" is expanded into
            "data_load_tool.sources.sql_database.sql_database".
