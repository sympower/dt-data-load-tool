...
from data_load_tool.common.configuration.specs import ConfigSectionContext, known_sections
from data_load_tool.common.data_writers.writers import EMPTY_DATA_WRITER_METRICS, TDataItemFormat
...
from data_load_tool.common.typing import TColumnNames
...
from data_load_tool.common.storages import NormalizeStorageConfiguration, LoadPackageInfo, SchemaStorage
...
from data_load_tool.common.utils import get_callable_name, get_full_obj_class_name, group_dict_of_lists

from data_load_tool.extract.decorators import SourceInjectableContext, SourceSchemaInjectableContext
from data_load_tool.extract.exceptions import DataItemRequiredForDynamicTableHints, UnknownSourceReference
from data_load_tool.extract.incremental import IncrementalResourceWrapper
...
from data_load_tool.extract.extractors import ObjectExtractor, ArrowExtractor, Extractor
from data_load_tool.extract.utils import get_data_item_format
...
class Extract(WithStepInfo[ExtractMetrics, ExtractInfo]):
    ...
    def gather_metrics(self, load_id: str, source: DltSource) -> None:
        ...
        # NOTE: there may be more than one extract run per load id: ie. the resource and then data_load_tool state
