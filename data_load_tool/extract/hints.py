...
from data_load_tool.common.typing import TDataItem, TColumnNames
from data_load_tool.common.time import ensure_pendulum_datetime
from data_load_tool.common.utils import clone_dict_nested
from data_load_tool.common.normalizers.json.relational import DataItemNormalizer
from data_load_tool.common.validation import validate_dict_ignoring_xkeys
from data_load_tool.extract.exceptions import (
    DataItemRequiredForDynamicTableHints,
    InconsistentTableTemplate,
)
from data_load_tool.extract.incremental import Incremental, TIncrementalConfig
from data_load_tool.extract.items import TFunHintTemplate, TTableHintTemplate, TableNameMeta
from data_load_tool.extract.items_transform import ValidateItem
from data_load_tool.extract.utils import ensure_table_schema_columns, ensure_table_schema_columns_hint
from data_load_tool.extract.validation import create_item_validator
...
def make_hints(
    ...
    This method accepts the same table hints arguments as `data_load_tool.resource` decorator.
    """
...
class DltResourceHints:
    ...
    def apply_hints(
        ...
        This method accepts the same table hints arguments as `data_load_tool.resource` decorator with the following additions.
        ...
        In non-aware resources, `data_load_tool` will filter out the loaded values, however, the resource will yield all the values again.
