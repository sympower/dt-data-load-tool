...
from data_load_tool.common.configuration.specs import BaseConfiguration, known_sections
from data_load_tool.common.configuration.specs.config_section_context import ConfigSectionContext
from data_load_tool.common.typing import AnyFun, DictStrAny, StrAny, TDataItem, TDataItems, NoneType
...
from data_load_tool.common.utils import flatten_list_or_items, get_callable_name, uniq_id
from data_load_tool.common.schema.typing import TTableSchema
from data_load_tool.extract.utils import wrap_async_iterator, wrap_parallel_iterator

from data_load_tool.extract.items import (
    DataItemWithMeta,
    TableNameMeta,
)
from data_load_tool.extract.items_transform import (
    FilterItem,
    MapItem,
    YieldMapItem,
    ValidateItem,
...
from data_load_tool.extract.hints import DltResourceHints, HintsMeta, TResourceHints
...
class DltResource(Iterable[TDataItem], DltResourceHints):
    """Implements data_load_tool resource. Contains a data pipe that wraps a generating item and table schema that can be adjusted"""
    ...
    def add_map(
        ...
        `item_map` receives single data items, `data_load_tool` will enumerate any lists of data items automatically
    ...
    def add_yield_map(
        ...
        `item_map` receives single data items, `data_load_tool` will enumerate any lists of data items automatically. It may yield 0 or more data items and be used to
    ...
    def add_filter(
        ...
        `item_filter` receives single data items, `data_load_tool` will enumerate any lists of data items automatically
