...
from data_load_tool.common.reflection.exceptions import ReferenceImportError
from data_load_tool.common.reflection.ref import ImportTrace
from data_load_tool.common.utils import get_callable_name
...
class PipeGenInvalid(PipeException):
    def __init__(self, pipe_name: str, gen: Any) -> None:
        ...
        msg += (
            " data_load_tool will evaluate functions that were passed as data argument. If you passed a"
        ...
        if "DltSource" in type_name:
            msg += " Did you pass a @data_load_tool.source decorated function without calling it?"
        if "DltResource" in type_name:
            msg += " Did you pass a function that returns data_load_tool.resource without calling it?"
...
class InvalidResourceDataTypeFunctionNotAGenerator(InvalidResourceDataType):
    def __init__(self, resource_name: str, item: Any, _typ: Type[Any]) -> None:
        super().__init__(
            ...
            item,
            _typ,
            "Please make sure that function decorated with @data_load_tool.resource uses 'yield' to return the"
            " data.",
        )
...
class InvalidResourceDataTypeMultiplePipes(InvalidResourceDataType):
    def __init__(self, resource_name: str, item: Any, _typ: Type[Any]) -> None:
        super().__init__(
            ...
            " often happens when you are creating a source with @data_load_tool.source decorator that has"
...
class InvalidTransformerDataTypeGeneratorFunctionRequired(InvalidResourceDataType):
    def __init__(self, resource_name: str, item: Any, _typ: Type[Any]) -> None:
        super().__init__(
            ...
            item,
            _typ,
            "Transformer must be a function decorated with @data_load_tool.transformer that takes data item as"
...
class ResourceInnerCallableConfigWrapDisallowed(DltResourceException):
    def __init__(self, resource_name: str, section: str) -> None:
        ...
        msg = (
            ...
            " 'data_load_tool.secrets.values' or 'data_load_tool.config.value' is disallowed for resources that are"
            " inner functions. Use the data_load_tool.source to get the required configuration and pass them"
...
class InvalidResourceDataTypeIsNone(InvalidResourceDataType):
    def __init__(self, resource_name: str, item: Any, _typ: Type[Any]) -> None:
        super().__init__(
            ...
            item,
            _typ,
            "Resource data missing. Did you forget the return statement in @data_load_tool.resource decorated"
            " function?",
        )
...
class ResourceFunctionExpected(InvalidResourceDataType):
    def __init__(self, resource_name: str, item: Any, _typ: Type[Any]) -> None:
        super().__init__(
            ...
            f" {_typ.__name__} found. Please decorate a function with @data_load_tool.resource",
        )
...
class InvalidParentResourceDataType(InvalidResourceDataType):
    def __init__(self, resource_name: str, item: Any, _typ: Type[Any]) -> None:
        super().__init__(
            ...
            " use '@data_load_tool.resource` decorator or `resource` function?",
        )
...
class InvalidParentResourceIsAFunction(DltResourceException):
    def __init__(self, resource_name: str, func_name: str) -> None:
        ...
        super().__init__(
            ...
            " function. Please decorate it with '@data_load_tool.resource' or pass to 'resource' function.",
        )
...
class SourceExhausted(DltSourceException):
    def __init__(self, source_name: str) -> None:
        ...
        super().__init__(
            ...
            " source to data_load_tool pipeline only once."
        )
...
class SourceNotAFunction(DltSourceException):
    def __init__(self, source_name: str, item: Any, _typ: Type[Any]) -> None:
        ...
        super().__init__(
            ...
            f" {_typ.__name__}. Please decorate a function with @data_load_tool.source"
        )
...
class SourceIsAClassTypeError(DltSourceException):
    def __init__(self, source_name: str, _typ: Type[Any]) -> None:
        ...
        super().__init__(
            ...
            " decorate classes with @data_load_tool.source. Instead implement __call__ in your class and pass"
            " instance of such class to data_load_tool.source() directly"
        )
...
class CurrentSourceSchemaNotAvailable(DltSourceException):
    def __init__(self) -> None:
        super().__init__(
            ...
            " data_load_tool.source or data_load_tool.resource"
        )
...
class CurrentSourceNotAvailable(DltSourceException):
    def __init__(self) -> None:
        super().__init__(
            ...
            " data_load_tool.resource or data_load_tool.transformer during the extract step"
        )
