...
from data_load_tool.common.managed_thread_pool import ManagedThreadPool
from data_load_tool.common.configuration.specs import RuntimeConfiguration
from data_load_tool.common.runtime.exec_info import get_execution_context, TExecutionContext, run_context_name
...
def init_anon_tracker(config: RuntimeConfiguration) -> None:
    ...
    global requests
    from data_load_tool.sources.helpers import requests as r_
