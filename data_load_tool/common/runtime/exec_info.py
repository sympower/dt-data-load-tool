...
from data_load_tool.common.runtime.typing import TExecutionContext, TVersion, TExecInfoNames
from data_load_tool.common.typing import StrStr, StrAny, List
from data_load_tool.common.utils import filter_env_vars
from data_load_tool.version import __version__, DLT_PKG_NAME
...
def dlt_version_info(pipeline_name: str) -> StrStr:
    """Gets data_load_tool version info including commit and image version available in docker"""
...
def get_plus_version() -> TVersion:
    "Gets data_load_tool+ library version"
    try:
