...
from data_load_tool.common.exceptions import DltException, TerminalValueError
...
class InStorageSchemaModified(SchemaStorageException):
    def __init__(self, schema_name: str, storage_path: str) -> None:
        msg = (
            ...
            " data_load_tool to provide external changes."
        )
        super().__init__(msg)
...
class CurrentLoadPackageStateNotAvailable(StorageException):
    def __init__(self) -> None:
        super().__init__(
            ...
            " only available in a function decorated with @data_load_tool.destination during loading."
        )
