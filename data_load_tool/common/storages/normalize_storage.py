...
from data_load_tool.common.storages.load_package import PackageStorage
from data_load_tool.common.storages.configuration import NormalizeStorageConfiguration
        ...
        if from_version == "1.0.0" and from_version < to_version:
            ...
            if len(self.list_files_to_normalize_sorted()) > 0:
                raise StorageMigrationError(
                    ...
                    " files or normalize it with data_load_tool 0.3.x",
                )
