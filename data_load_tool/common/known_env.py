"""Defines env variables that `data_load_tool` uses independently of its configuration system"""

DLT_PROJECT_DIR = "DLT_PROJECT_DIR"
"""The data_load_tool project dir is the current working directory, '.' (current working dir) by default"""
...
"""Python namespace default where naming modules reside, defaults to data_load_tool.common.normalizers.naming"""
