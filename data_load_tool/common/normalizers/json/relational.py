...
from data_load_tool.common.normalizers.typing import TJSONNormalizer
from data_load_tool.common.normalizers.utils import generate_dlt_id
from data_load_tool.common.typing import DictStrAny, TDataItem, StrAny
...
from data_load_tool.common.normalizers.json import (
    TNormalizedRowIterator,
    wrap_in_dict,
    DataItemNormalizer as DataItemNormalizerBase,
)
from data_load_tool.common.normalizers.json.typing import (
    RelationalNormalizerConfig,
    RelationalNormalizerConfigPropagation,
)
from data_load_tool.common.normalizers.json.helpers import (
    get_nested_row_hash,
    get_primary_key,
