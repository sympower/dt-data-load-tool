...
from data_load_tool.common.schema.typing import TColumnSchema, TColumnSchemaBase
...
#             " dataset name to the destination configuration ie. via data_load_tool pipeline."
#         )
...
class SchemaEngineNoUpgradePathException(SchemaException):
    def __init__(
        ...
        super().__init__(
            ...
            f" stopped at {from_engine}. You possibly tried to run an older data_load_tool"
