...
from data_load_tool.common.schema.configuration import SchemaConfiguration
from data_load_tool.common.normalizers.exceptions import InvalidJsonNormalizer
from data_load_tool.common.normalizers.json import SupportsDataItemNormalizer, DataItemNormalizer
...
from data_load_tool.common.normalizers.typing import (
    TJSONNormalizer,
    TNormalizersConfig,
    TNamingConventionReferenceArg,
)
from data_load_tool.common.typing import is_subclass
from data_load_tool.common.utils import get_full_obj_class_name

DEFAULT_NAMING_NAMESPACE = os.environ.get(
    known_env.DLT_DEFAULT_NAMING_NAMESPACE, "data_load_tool.common.normalizers.naming"
)
...
def configured_normalizers(
    naming: TNamingConventionReferenceArg = data_load_tool.config.value,
    json_normalizer: TJSONNormalizer = data_load_tool.config.value,
...
def import_normalizers(
    ...
    item_normalizer.setdefault("module", "data_load_tool.common.normalizers.json.relational")
    ...
    if destination_capabilities and destination_capabilities.max_table_nesting is not None:
        ...
        from data_load_tool.common.normalizers.json.relational import DataItemNormalizer
...
def naming_from_reference(
    ...
    Reference may be: (1) shorthand name pointing to `data_load_tool.common.normalizers.naming` namespace
    ...
    def _import_naming(module: str) -> ModuleType:
        if "." in module:
            ...
            if module == "data_load_tool.common.normalizers.names.snake_case":
