...
from data_load_tool.common.normalizers.naming.snake_case import NamingConvention as SnakeCase
from data_load_tool.common.typing import DictStrAny, REPattern
from data_load_tool.common.validation import TCustomValidator, validate_dict_ignoring_xkeys
from data_load_tool.common.schema import detections
...
def is_nested_table(table: TTableSchema) -> bool:
    """Checks if table is a data_load_tool nested table: connected to parent table via row_key - parent_key reference"""
...
def dlt_id_column() -> TColumnSchema:
    """Definition of data_load_tool id column"""
    return {
        "name": C_DLT_ID,
        "data_type": "text",
        "nullable": False,
...
def dlt_load_id_column() -> TColumnSchema:
    """Definition of data_load_tool load id column"""
