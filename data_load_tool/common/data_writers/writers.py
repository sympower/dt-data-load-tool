...
from data_load_tool.common.data_writers.exceptions import (
    SpecLookupFailed,
    DataWriterNotFound,
...
from data_load_tool.common.data_writers.configuration import (
...
class ParquetDataWriter(DataWriter):
    ...
    def _create_writer(self, schema: "pa.Schema") -> "pa.parquet.ParquetWriter":
        from data_load_tool.common.libs.pyarrow import pyarrow, get_py_arrow_timestamp
    ...
    def write_header(self, columns_schema: TTableSchemaColumns) -> None:
        from data_load_tool.common.libs.pyarrow import columns_to_arrow
...
class ArrowToParquetWriter(ParquetDataWriter):
    ...
    def write_data(self, items: Sequence[TDataItem]) -> None:
        from data_load_tool.common.libs.pyarrow import concat_batches_and_tables_in_order
