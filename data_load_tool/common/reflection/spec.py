...
from data_load_tool.common.configuration import configspec, is_valid_hint, is_secret_hint
...
def spec_from_signature(
    ...
    Special default markers for required SPEC fields `data_load_tool.secrets.value` and `data_load_tool.config.value` are sentinel
    string values with a type set to Any during typechecking. The sentinels are defined in data_load_tool.common.typing module.
