...
from data_load_tool.common.configuration.specs.base_configuration import extract_inner_hint
from data_load_tool.common.destination.typing import PreparedTableSchema
from data_load_tool.common.destination.utils import verify_schema_capabilities, verify_supported_data_types
...
from data_load_tool.common.configuration import configspec, NotResolved
from data_load_tool.common.configuration.specs import BaseConfiguration, CredentialsConfiguration
...
from data_load_tool.common.destination.utils import prepare_load_table
...
from data_load_tool.common.storages.load_package import LoadJobInfo, TPipelineStateDoc
from data_load_tool.common.typing import is_optional_type
...
class DestinationClientDwhWithStagingConfiguration(DestinationClientDwhConfiguration):
    ...
    """If data_load_tool should truncate the tables on staging destination before loading data."""
