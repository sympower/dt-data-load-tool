...
from data_load_tool.common.normalizers.typing import TNamingConventionReferenceArg
from data_load_tool.common.typing import TLoaderFileFormat
from data_load_tool.common.configuration.utils import serialize_value
...
class DataTypeMapper(ABC):
    def __init__(self, capabilities: "DestinationCapabilitiesContext") -> None:
        """Maps data_load_tool data types into destination data types"""
    ...
    def ensure_supported_type(
        ...
        """Makes sure that data_load_tool type in `column` in prepared `table`  is supported by the destination for a given file format"""
        pass
