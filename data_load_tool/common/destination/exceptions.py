...
from data_load_tool.common.exceptions import DltException, TerminalException, TransientException
...
class UnknownDestinationModule(ReferenceImportError, DestinationException, KeyError):
    ...
    def __str__(self) -> str:
        if "." in self.ref:
            ...
            msg = f"Destination {self.ref} is not one of the standard data_load_tool destinations."
