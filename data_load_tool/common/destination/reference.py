...
from data_load_tool.common.configuration import resolve_configuration, known_sections
...
from data_load_tool.common.runtime.run_context import get_plugin_modules
from data_load_tool.common.schema.schema import Schema
from data_load_tool.common.typing import is_subclass
from data_load_tool.common.utils import get_full_callable_name
from data_load_tool.common.reflection.ref import object_from_ref
...
class DestinationReference:
    ...
    def normalize_type(destination_type: str) -> str:
        ...
        if "." not in destination_type:
            destination_type = "data_load_tool.destinations." + destination_type
        # the next two lines shorten the data_load_tool internal destination paths to data_load_tool.destinations.<destination_type>
    ...
    def find(
        ...
        The ref can be a destination name or import path pointing to a destination class (e.g. `data_load_tool.destinations.postgres`)
