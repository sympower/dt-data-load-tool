...
from data_load_tool.common.exceptions import DltException, TerminalException
from data_load_tool.common.utils import main_module_file_path
    ...
    def __str__(self) -> str:
        ...
        if main_path:
            ...
            if abs_main_dir != os.getcwd():
                ...
                msg += (
                    "WARNING: data_load_tool looks for .data_load_tool folder in your current working directory and your"
