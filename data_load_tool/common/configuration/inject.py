...
from data_load_tool.common.typing import DictStrAny, TFun, AnyFun
from data_load_tool.common.configuration.resolve import resolve_configuration, inject_section
from data_load_tool.common.configuration.specs.base_configuration import BaseConfiguration
...
def with_config(
    ...
    The synthesized spec contains the arguments marked with `data_load_tool.secrets.value` and `data_load_tool.config.value` which are required to be injected at runtime.
    ...
    Args:
        ...
        include_defaults (bool, optional): If True then arguments with default values will be included in synthesized spec. If False only the required arguments marked with `data_load_tool.secrets.value` and `data_load_tool.config.value` are included
