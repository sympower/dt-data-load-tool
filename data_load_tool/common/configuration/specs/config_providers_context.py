...
from data_load_tool.common.configuration.exceptions import DuplicateConfigProviderException
...
def _airflow_providers() -> List[ConfigProvider]:
    ...
    try:
        ...
        with contextlib.redirect_stdout(io.StringIO()), contextlib.redirect_stderr(io.StringIO()):
            # try to get data_load_tool secrets variable. many broken Airflow installations break here. in that case do not create
        ...
        if secrets_toml_var is None:
            message = (
                ...
                " secrets.toml."
                + "If you do not use Airflow variables to hold data_load_tool configuration or use variables"
