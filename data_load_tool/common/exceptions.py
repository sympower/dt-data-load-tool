...
class PipelineStateNotAvailable(PipelineException):
    def __init__(self, source_state_key: Optional[str] = None) -> None:
        ...
        msg += (
            " Call data_load_tool.pipeline(...) before you call the @data_load_tool.source or  @data_load_tool.resource decorated"
            " function."
        )
...
class ResourceNameNotAvailable(PipelineException):
    def __init__(self) -> None:
        super().__init__(
            ...
            " state may be only requested from @data_load_tool.resource decorated function or with explicit"
            " resource name.",
        )
...
class SourceSectionNotAvailable(PipelineException):
    def __init__(self) -> None:
        msg = (
            ...
            " from within the @data_load_tool.source and @data_load_tool.resource decorated function."
        )
        super().__init__(None, msg)
