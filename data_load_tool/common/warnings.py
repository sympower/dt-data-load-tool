...
class DltDeprecationWarning(DeprecationWarning):
    """A data_load_tool specific deprecation warning.

    This warning is raised when using deprecated functionality in data_load_tool. It provides information on when the
    ...
    def __str__(self) -> str:
        message = (
            f"{self.message}. Deprecated in data_load_tool {self.since} to be removed in {self.expected_due}."
        )
        return message
...
# show data_load_tool deprecations once
