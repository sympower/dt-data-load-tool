...
from data_load_tool.cli.docs_command import render_argparse_markdown
from data_load_tool.cli.command_wrappers import (
    ...
    def configure_parser(self, parser: argparse.ArgumentParser) -> None:
        ...
        parser.add_argument(
            ...
            help=(
                ...
                " source, it checks if your local `data_load_tool` version requires an update and prints the"
                " relevant warning."
            ),
        )
        parser.add_argument(
...
""",
    ...
    def execute(self, args: argparse.Namespace) -> None:
        ...
        if not deploy_command_available:
            ...
            fmt.secho('pip install "data_load_tool[cli]"', bold=True)
            fmt.echo(
...
If you are reading this on the docs website, you are looking at the rendered version of the cli docs generated by this command.
    ...
    def execute(self, args: argparse.Namespace) -> None:
        from data_load_tool.cli._dlt import _create_parser

        parser, _ = _create_parser()

        result = render_argparse_markdown("data_load_tool", parser)
