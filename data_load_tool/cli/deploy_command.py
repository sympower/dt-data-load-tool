...
from data_load_tool.common.configuration.providers import SECRETS_TOML, SECRETS_TOML_KEY
from data_load_tool.common.configuration.utils import serialize_value
from data_load_tool.common.git import is_dirty

from data_load_tool.cli import utils
from data_load_tool.cli import echo as fmt
from data_load_tool.cli.deploy_command_helpers import (
    PipelineWasNotRun,
    BaseDeployment,
    ask_files_overwrite,
    generate_pip_freeze,
...
from data_load_tool.version import DLT_PKG_NAME

from data_load_tool.common.destination.reference import Destination
    ...
    def _generate_workflow(self, *args: Optional[Any]) -> None:
        ...
        if self.schedule_description is None:
            ...
            raise ValueError(
                ...
                f" as 'data_load_tool deploy chess.py {self.deployment_method} --schedule \"*/30 * * * *\"'."
            )
...
class AirflowDeployment(BaseDeployment):
    ...
    def _echo_instructions(self, *args: Optional[Any]) -> None:
        ...
        fmt.echo("4. Add data_load_tool package below using Google Composer UI.")
