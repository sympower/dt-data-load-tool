...
from data_load_tool.cli.exceptions import VerifiedSourceRepoError
...
from data_load_tool.common.reflection.utils import get_module_docstring
...
TEMPLATE_FILES = [".gitignore", ".data_load_tool/config.toml"]
...
def get_core_source_configuration(
    ...
    return SourceConfiguration(
        "core",
        "data_load_tool.sources." + source_name,
        sources_storage,
        src_pipeline_file,
        dest_pipeline_file,
        files,
