...
from data_load_tool.cli.pipeline_command import pipeline_command, DLT_PIPELINE_COMMAND_DOCS_URL
from data_load_tool.cli.telemetry_command import (
...
try:
    from data_load_tool.cli import deploy_command
...
def pipeline_command_wrapper(
    ...
    try:
        ...
        click.secho(
            ...
            % fmt.bold(f"data_load_tool pipeline {pipeline_name} sync")
        )
