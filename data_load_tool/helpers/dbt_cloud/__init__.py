...
from data_load_tool.common.configuration import known_sections, with_config
from data_load_tool.helpers.dbt_cloud.client import DBTCloudClientV2
from data_load_tool.helpers.dbt_cloud.configuration import DBTCloudConfiguration
...
def run_dbt_cloud_job(
    credentials: DBTCloudConfiguration = data_load_tool.secrets.value,
    ...
    Args:
        credentials (DBTCloudConfiguration): Configuration parameters for dbt Cloud.
            Defaults to data_load_tool.secrets.value.
