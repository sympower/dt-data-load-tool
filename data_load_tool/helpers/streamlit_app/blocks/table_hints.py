...
from data_load_tool.common.schema.typing import TTableSchema, TColumnSchema
from data_load_tool.common.utils import flatten_list_or_items
from data_load_tool.helpers.streamlit_app.blocks.resource_state import resource_state_info
from data_load_tool.helpers.streamlit_app.blocks.show_data import show_data_button


def list_table_hints(pipeline: data_load_tool.Pipeline, tables: List[TTableSchema]) -> None:
