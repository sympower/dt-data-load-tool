...
from data_load_tool.common.destination import TDestinationReferenceArg, Destination
...
try:
    ...
    raise MissingDependencyException("data_load_tool ibis helpers", ["ibis-framework"])


SUPPORTED_DESTINATIONS = [
    "data_load_tool.destinations.postgres",
    "data_load_tool.destinations.duckdb",
    "data_load_tool.destinations.motherduck",
    "data_load_tool.destinations.filesystem",
    "data_load_tool.destinations.bigquery",
    "data_load_tool.destinations.snowflake",
    "data_load_tool.destinations.redshift",
    "data_load_tool.destinations.mssql",
    "data_load_tool.destinations.synapse",
    "data_load_tool.destinations.clickhouse",
    ...
    # does not work yet.
    # "data_load_tool.destinations.athena",
]


# Map data_load_tool data types to ibis data types
DATA_TYPE_MAP = {
    "text": "string",
    "double": "float64",
    "bool": "boolean",
...
def create_ibis_backend(
    ...
    if destination_type in ["data_load_tool.destinations.motherduck", "data_load_tool.destinations.duckdb"]:
        import duckdb
        ...
        if destination_type == "data_load_tool.destinations.redshift":
            # patch psycopg
            try:
    ...
    elif destination_type == "data_load_tool.destinations.snowflake":
        from data_load_tool.destinations.impl.snowflake.snowflake import SnowflakeClient
    ...
    elif destination_type in ["data_load_tool.destinations.mssql", "data_load_tool.destinations.synapse"]:
    ...
    elif destination_type == "data_load_tool.destinations.bigquery":
    ...
    elif destination_type == "data_load_tool.destinations.clickhouse":
    ...
    elif destination_type == "data_load_tool.destinations.filesystem":
        import duckdb
        from data_load_tool.destinations.impl.filesystem.sql_client import (
            FilesystemClient,
            FilesystemSqlClient,
        )
        from data_load_tool.destinations.impl.duckdb.factory import DuckDbCredentials
...
def create_unbound_ibis_table(
    ...
    """Create an unbound ibis table from a data_load_tool schema"""
    ...
    # Convert data_load_tool table schema columns to ibis schema
    ibis_schema = {
    ...
    # create unbound ibis table and return in data_load_tool wrapper
