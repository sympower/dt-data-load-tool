import os
import contextlib
from data_load_tool.common.exceptions import VenvNotFound
from data_load_tool.common.runners import Venv
from data_load_tool.common.schema import Schema
from data_load_tool.common.typing import ConfigValue, TSecretStrValue
...
def get_venv(
    ...
    with contextlib.suppress(VenvNotFound):
        # TODO: check data_load_tool version in venv and update it if local version updated
...
def package(
    ...
    The wrapper creates a `dbt` profile from `data_load_tool` pipeline configuration. Specifically:
