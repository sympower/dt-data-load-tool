...
from data_load_tool.common.schema.typing import PIPELINE_STATE_TABLE_NAME
...
from data_load_tool.common.destination.client import WithStateSync, StateInfo
...
from data_load_tool.common.pipeline import TPipelineState
    ...
    return {
        **default_versioned_state(),
        ...
        "_local": {
            ...
            "initial_cwd": os.path.abspath(data_load_tool.current.run_context().local_dir),
        },
    }
