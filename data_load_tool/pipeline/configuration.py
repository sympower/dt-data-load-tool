...
from data_load_tool.common.typing import AnyFun, TSecretStrValue
from data_load_tool.common.utils import digest256
from data_load_tool.common.destination import TLoaderFileFormat, TDestinationReferenceArg
...
class PipelineConfiguration(BaseConfiguration):
    ...
    """Enables the tracing. Tracing saves the execution trace locally and is required by `data_load_tool deploy`."""
    ...
    """Refresh mode for the pipeline to fully or partially reset a source during run. See docstring of `data_load_tool.pipeline` for more details."""
