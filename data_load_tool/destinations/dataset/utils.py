...
from data_load_tool.common.destination import AnyDestination, Destination
...
def get_destination_clients(
    ...
    try:
        ...
        raise MissingDependencyException(
            ...
            "Dependencies for specific destinations are available as extras of data_load_tool",
        )
