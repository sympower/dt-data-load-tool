...
from data_load_tool.destinations.dataset.relation import BaseReadableDBAPIRelation
...
try:
    from data_load_tool.helpers.ibis import Expr
except MissingDependencyException:
    Expr = Any

# map data_load_tool destination to sqlglot dialect
DIALECT_MAP = {
    "data_load_tool.destinations.duckdb": "duckdb",  # works
    "data_load_tool.destinations.motherduck": "duckdb",  # works
    "data_load_tool.destinations.clickhouse": "clickhouse",  # works
    "data_load_tool.destinations.databricks": "databricks",  # works
    "data_load_tool.destinations.bigquery": "bigquery",  # works
    "data_load_tool.destinations.postgres": "postgres",  # works
    "data_load_tool.destinations.redshift": "redshift",  # works
    "data_load_tool.destinations.snowflake": "snowflake",  # works
    "data_load_tool.destinations.mssql": "tsql",  # works
    "data_load_tool.destinations.synapse": "tsql",  # works
    "data_load_tool.destinations.athena": "trino",  # works
    "data_load_tool.destinations.filesystem": "duckdb",  # works
    "data_load_tool.destinations.dremio": "presto",  # works
    # NOTE: can we discover the current dialect in sqlalchemy?
    "data_load_tool.destinations.sqlalchemy": "mysql",  # may work
}
...
class ReadableIbisRelation(BaseReadableDBAPIRelation):
    ...
    def query(self) -> Any:
        """build the query"""
        from data_load_tool.helpers.ibis import ibis, sqlglot
