...
from data_load_tool.common.destination.reference import TDestinationReferenceArg, Destination
from data_load_tool.common.destination.client import JobClientBase, WithStateSync
from data_load_tool.common.destination.dataset import SupportsReadableRelation, SupportsReadableDataset
...
from data_load_tool.destinations.dataset.relation import ReadableDBAPIRelation
from data_load_tool.destinations.dataset.utils import get_destination_clients

if TYPE_CHECKING:
    try:
        from data_load_tool.helpers.ibis import BaseBackend as IbisBackend
...
class ReadableDBAPIDataset(SupportsReadableDataset):
    ...
    def ibis(self) -> IbisBackend:
        ...
        from data_load_tool.helpers.ibis import create_ibis_backend
    ...
    def table(self, table_name: str) -> SupportsReadableRelation:
        ...
        if table_name in self.schema.tables and self._dataset_type in ("auto", "ibis"):
            try:
                from data_load_tool.helpers.ibis import create_unbound_ibis_table
