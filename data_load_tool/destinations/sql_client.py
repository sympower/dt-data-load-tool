...
from data_load_tool.common.typing import TFun, TypedDict, Self
...
from data_load_tool.common.utils import concat_strings_with_limit
...
from data_load_tool.destinations.typing import (
    DBApi,
    TNativeConn,
    DataFrame,
    DBTransaction,
...
class DBApiCursorImpl(DBApiCursor):
    ...
    def iter_df(self, chunk_size: int) -> Generator[DataFrame, None, None]:
        ...
        from data_load_tool.common.libs.pandas import pandas as pd
