...
from data_load_tool.common.destination import DestinationCapabilitiesContext, PreparedTableSchema
from data_load_tool.common.destination.client import FollowupJobRequest, SupportsStagingDestination, LoadJob
from data_load_tool.common.destination.dataset import DBApiCursor
from data_load_tool.common.data_writers.escape import escape_hive_identifier
from data_load_tool.destinations.sql_jobs import SqlStagingCopyFollowupJob, SqlMergeFollowupJob

from data_load_tool.destinations.typing import DBApi, DBTransaction
from data_load_tool.destinations.exceptions import (
    DatabaseTerminalException,
    DatabaseTransientException,
    DatabaseUndefinedRelation,
)
from data_load_tool.destinations.sql_client import (
    SqlClientBase,
    DBApiCursorImpl,
    raise_database_error,
    raise_open_connection_error,
)
from data_load_tool.destinations.job_client_impl import SqlJobClientWithStagingDataset
from data_load_tool.destinations.job_impl import FinalizedLoadJobWithFollowupJobs, FinalizedLoadJob
from data_load_tool.destinations.impl.athena.configuration import AthenaClientConfiguration
from data_load_tool.destinations import path_utils
from data_load_tool.destinations.impl.athena.athena_adapter import PARTITION_HINT
...
class AthenaClient(SqlJobClientWithStagingDataset, SupportsStagingDestination):
    ...
    def _is_iceberg_table(
        ...
        # all data_load_tool tables that are not loaded via files are iceberg tables, no matter if they are on staging or regular dataset
