...
from data_load_tool.destinations.impl.duckdb.factory import DuckDbTypeMapper
...
if t.TYPE_CHECKING:
    ...
    from data_load_tool.destinations.impl.motherduck.motherduck import MotherDuckClient
