...
from data_load_tool.common.json import json, PY_DATETIME_DECODERS
from data_load_tool.destinations.sql_jobs import SqlFollowupJob, SqlJobParams

from data_load_tool.destinations.impl.sqlalchemy.db_api_client import SqlalchemyClient
from data_load_tool.destinations.impl.sqlalchemy.merge_job import SqlalchemyMergeFollowupJob
...
class SqlalchemyParquetInsertJob(SqlalchemyJsonLInsertJob):
    def _iter_data_item_chunks(self) -> Iterator[Sequence[Dict[str, Any]]]:
        from data_load_tool.common.libs.pyarrow import ParquetFile
