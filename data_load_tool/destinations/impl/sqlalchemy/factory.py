...
from data_load_tool.common.destination import Destination, DestinationCapabilitiesContext
from data_load_tool.common.destination.capabilities import DataTypeMapper
from data_load_tool.common.arithmetics import DEFAULT_NUMERIC_PRECISION, DEFAULT_NUMERIC_SCALE
from data_load_tool.common.normalizers import NamingConvention

from data_load_tool.destinations.impl.sqlalchemy.configuration import (
    SqlalchemyCredentials,
    SqlalchemyClientConfiguration,
)
from data_load_tool.common.data_writers.escape import format_datetime_literal

if t.TYPE_CHECKING:
    # from data_load_tool.destinations.impl.sqlalchemy.sqlalchemy_client import SqlalchemyJobClient
    from data_load_tool.destinations.impl.sqlalchemy.sqlalchemy_job_client import SqlalchemyJobClient
...
class sqlalchemy(Destination[SqlalchemyClientConfiguration, "SqlalchemyJobClient"]):
    ...
    def _raw_capabilities(self) -> DestinationCapabilitiesContext:
        ...
        try:
            from data_load_tool.destinations.impl.sqlalchemy.type_mapper import SqlalchemyTypeMapper
    ...
    def __init__(
        ...
        **kwargs: t.Any,
        ...
        All arguments provided here supersede other configuration sources such as environment variables and data_load_tool config files.
