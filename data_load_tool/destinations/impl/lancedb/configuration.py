...
from data_load_tool.destinations.impl.lancedb.warnings import uri_on_credentials_deprecated
...
class LanceDBClientConfiguration(WithLocalFiles, DestinationClientDwhConfiguration):
    ...
    concept of schemas, this table serves as a proxy to group related data_load_tool tables together."""
