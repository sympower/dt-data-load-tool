...
try:
    ...
    from data_load_tool.destinations.impl.lancedb.type_mapper import LanceDBTypeMapper
except MissingDependencyException:
    # assign mock type mapper if no arrow
    from data_load_tool.common.destination.capabilities import UnsupportedTypeMapper as LanceDBTypeMapper
