...
from data_load_tool.common.utils import removeprefix
...
from data_load_tool.destinations.typing import DBTransaction, DBApi
from data_load_tool.destinations.utils import _convert_to_old_pyformat
...
class ClickHouseSqlClient(
    ...
    def create_dataset(self) -> None:
        ...
        self.execute_sql(f"""
            ...
            COMMENT 'internal data_load_tool sentinel table'""")
    ...
    def drop_dataset(self) -> None:
        ...
        if self.dataset_name:
            ...
            # drop only tables known in logical (data_load_tool) schema
            to_drop_results = [
        ...
        if not self.dataset_name:
            ...
            logger.warning(
                ...
                " current data_load_tool schema and sentinel tables were removed."
            )
        else:
