...
from data_load_tool.destinations.impl.weaviate.configuration import (
    WeaviateCredentials,
...
class weaviate(Destination[WeaviateClientConfiguration, "WeaviateClient"]):
    ...
    def _raw_capabilities(self) -> DestinationCapabilitiesContext:
        ...
        caps.naming_convention = "data_load_tool.destinations.impl.weaviate.naming"
    ...
    def __init__(
        ...
        **kwargs: t.Any,
        ...
        All destination config parameters can be provided as arguments here and will supersede other config sources (such as data_load_tool config files and environment variables).
