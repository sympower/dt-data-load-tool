...
class BigQueryClientConfiguration(DestinationClientDwhWithStagingConfiguration):
    ...
    """If True then data_load_tool expects to load data into case sensitive dataset"""
    should_set_case_sensitivity_on_new_dataset: bool = False
    """If True, data_load_tool will set case sensitivity flag on created datasets that corresponds to naming convention"""
