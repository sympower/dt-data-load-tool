...
from data_load_tool.common.runtime.signals import sleep
from data_load_tool.common.schema import TColumnSchema, Schema, TTableSchemaColumns
from data_load_tool.common.schema.typing import TColumnType
from data_load_tool.common.schema.utils import get_inherited_table_hint, get_columns_names_with_prop
from data_load_tool.common.storages.load_package import destination_state
...
from data_load_tool.destinations.impl.bigquery.sql_client import BigQuerySqlClient, BQ_TERMINAL_REASONS
from data_load_tool.destinations.job_client_impl import SqlJobClientWithStagingDataset
from data_load_tool.destinations.job_impl import DestinationJsonlLoadJob, DestinationParquetLoadJob
from data_load_tool.destinations.job_impl import ReferenceFollowupJobRequest
from data_load_tool.destinations.sql_jobs import SqlMergeFollowupJob
...
"""
    ...
    def _create_load_job(self, table: PreparedTableSchema, file_path: str) -> bigquery.LoadJob:
        ...
        if should_autodetect_schema(table):
            # Allow BigQuery to infer and evolve the schema, note that data_load_tool is not creating such tables at all.
...
def _streaming_load(
    ...
    Args:
        sql_client (data_load_tool.destinations.impl.bigquery.bigquery.BigQueryClient):
            BigQuery client.
