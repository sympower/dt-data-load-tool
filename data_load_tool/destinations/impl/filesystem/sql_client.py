...
from data_load_tool.destinations.sql_client import raise_database_error
from data_load_tool.destinations.impl.duckdb.sql_client import DuckDbSqlClient
from data_load_tool.destinations.impl.duckdb.factory import duckdb as duckdb_factory, DuckDbCredentials
...
class FilesystemSqlClient(DuckDbSqlClient):
    ...
    def create_views_for_tables(self, tables: Dict[str, str]) -> None:
        ...
        for table_name in tables.keys():
            ...
            # data_load_tool tables are never compressed for now...
            ...
            if table_format == "delta":
                ...
                if is_abfss:
                    ...
                    from data_load_tool.common.libs.pyiceberg import _get_last_metadata_file
