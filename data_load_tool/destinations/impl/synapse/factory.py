...
from data_load_tool.common.destination import Destination, DestinationCapabilitiesContext, PreparedTableSchema
...
from data_load_tool.common.data_writers.escape import escape_postgres_identifier, escape_mssql_literal
...
if t.TYPE_CHECKING:
    from data_load_tool.destinations.impl.synapse.synapse import SynapseClient
