...
from data_load_tool.common.schema import TColumnSchema, Schema, TColumnHint
from data_load_tool.common.schema.utils import (
    table_schema_has_type,
    get_inherited_table_hint,
)

from data_load_tool.common.configuration.exceptions import ConfigurationException
from data_load_tool.common.configuration.specs import (
    AzureCredentialsWithoutDefaults,
    AzureServicePrincipalCredentialsWithoutDefaults,
)

from data_load_tool.destinations.impl.mssql.factory import MsSqlTypeMapper
...
from data_load_tool.destinations.impl.mssql.mssql import (
    MsSqlJobClient,
    VARCHAR_MAX_N,
    VARBINARY_MAX_N,
)
...
from data_load_tool.destinations.impl.synapse.configuration import SynapseClientConfiguration
from data_load_tool.destinations.impl.synapse.synapse_adapter import (
...
class SynapseClient(MsSqlJobClient, SupportsStagingDestination):
    ...
    def prepare_load_table(self, table_name: str) -> PreparedTableSchema:
        ...
        if table_name in self.schema.dlt_table_names():
            # data_load_tool tables should always be heap tables, because "for small lookup
