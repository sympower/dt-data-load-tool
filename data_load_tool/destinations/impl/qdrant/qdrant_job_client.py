...
from data_load_tool.common.schema.typing import C_DLT_LOAD_ID
...
from data_load_tool.destinations.impl.qdrant.configuration import QdrantClientConfiguration
from data_load_tool.destinations.impl.qdrant.qdrant_adapter import VECTORIZE_HINT
...
class QDrantLoadJob(RunnableLoadJob):
    ...
    def _list_unique_identifiers(self, table_schema: PreparedTableSchema) -> Sequence[str]:
        ...
        Args:
            table_schema (PreparedTableSchema): a data_load_tool table schema.
