...
from data_load_tool.common import pendulum, logger
from data_load_tool.common.destination.capabilities import DataTypeMapper
...
from data_load_tool.common.storages.load_package import LoadJobInfo, ParsedLoadJobFileName
from data_load_tool.common.schema import TColumnSchema, Schema, TTableSchemaColumns, TSchemaTables
from data_load_tool.common.schema import TColumnHint
...
from data_load_tool.destinations.sql_jobs import SqlMergeFollowupJob, SqlStagingCopyFollowupJob
...
from data_load_tool.destinations.utils import (
...
class SqlJobClientBase(WithSqlClient, JobClientBase, WithStateSync):
    ...
    def __init__(
        ...
        # get definitions of the data_load_tool tables, normalize column names and keep for later use
    ...
    def get_storage_tables(
        ...
        possible to convert identifiers into INFORMATION SCHEMA back into case sensitive data_load_tool schema.
        """
...
WHERE """
    ...
    def _row_to_schema_info(self, query: str, *args: Any) -> StorageSchemaInfo:
        ...
        # TODO: Re-use decompress/compress_state() implementation from data_load_tool.pipeline.state_sync
    ...
    def _set_query_tags_for_job(self, load_id: str, table: PreparedTableSchema) -> None:
        ...
        from data_load_tool.common.pipeline import current_pipeline
