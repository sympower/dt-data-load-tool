...
With data_load_tool+ you can now run pipelines directly from the command line, allowing you to go to production faster:
...
```sh
data_load_tool project --profile prod my_pipeline run
```
