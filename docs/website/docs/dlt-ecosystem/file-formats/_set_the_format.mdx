<span>There are several ways of configuring data_load_tool to use <code>{props.file_type}</code> file format for normalization step and to store your data at the destination:</span>
...
<pre language="py">
@data_load_tool.resource(file_format="{props.file_type}"){'\n'}
